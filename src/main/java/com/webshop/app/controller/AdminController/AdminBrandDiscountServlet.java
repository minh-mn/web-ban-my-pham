...
public class AdminBrandDiscountServlet extends HttpServlet {
    ...
    private static final String BRAND_PROMOTION_TYPE = "BRAND";
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        /*
         * Giữ tương thích cho các form cũ đang POST về /admin/brand-discounts.
         * Request sẽ được forward nội bộ sang /admin/promotions,
         * đồng thời tự bổ sung type=BRAND để servlet quản lý khuyến mãi mới
         * xử lý đúng loại giảm giá thương hiệu.
         */
        HttpServletRequest wrappedRequest = new PromotionTypeRequestWrapper(req, BRAND_PROMOTION_TYPE);
    ...
    private String buildRedirectUrl(HttpServletRequest req) {
        ...
        /*
         * Ép type=BRAND để mọi link cũ /admin/brand-discounts đều được chuyển đúng tab
         * Giảm giá thương hiệu trong giao diện quản lý khuyến mãi tập trung.
         */
        params.put(PROMOTION_TYPE_PARAM, new String[]{BRAND_PROMOTION_TYPE});
