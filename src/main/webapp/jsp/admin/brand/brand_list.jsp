          ...
          <c:otherwise>
            <table class="admin-table">
              ...
              <tr>
                ...
                <th style="width:140px;">Hình ảnh</th> <th>Tên thương hiệu</th>
                    ...
                    <c:choose>
                      <c:when test="${not empty b.image}">
                        <img src="${pageContext.request.contextPath}${b.image}"
                             alt="${b.name}"
                             style="width: 70px; height: 45px; object-fit: contain; border-radius: 6px; border: 1px solid #e5e7eb; background-color: #fff; padding: 2px;" />
                      </c:when>
                      <c:otherwise>
                        <span style="color: #9ca3af; font-size: 13px; font-style: italic;">Chưa có ảnh</span>
                      </c:otherwise>
                    </c:choose>
                  </td>
