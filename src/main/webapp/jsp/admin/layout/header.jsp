...
<head>
	...
	<link rel="stylesheet"
	      href="${pageContext.request.contextPath}/assets/css/admin/admin-base.css?v=20260615_ui3">
	...
	<link rel="stylesheet"
	      href="${pageContext.request.contextPath}/assets/css/admin/admin-layout.css?v=20260615_ui3">

	<!-- Page CSS: list/form/detail CSS theo từng trang admin -->
	<c:if test="${not empty pageCss}">
		<link rel="stylesheet"
		      href="${pageContext.request.contextPath}${pageCss}?v=20260615_ui3">
	</c:if>
</head>
