...
<head>
	...
	<link rel="stylesheet"
	      href="${pageContext.request.contextPath}/assets/css/admin/admin-base.css?v=20260615_ui4">
	...
	<link rel="stylesheet"
	      href="${pageContext.request.contextPath}/assets/css/admin/admin-layout.css?v=20260615_ui4">

	<!-- Page CSS: list/form/detail CSS theo từng trang admin -->
	<c:if test="${not empty pageCss}">
		<link rel="stylesheet"
		      href="${pageContext.request.contextPath}${pageCss}?v=20260615_ui4">
	</c:if>
</head>
