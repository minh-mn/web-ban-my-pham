  ...
  <div class="policy-wrap">
    ...
    <section class="policy-hero">
      <div>
        ...
        <div class="policy-tags">
          <span>Áp dụng sau khi giao thành công</span>
          <span>Gửi yêu cầu trong 7 ngày</span>
      ...
      <aside class="policy-action-box">
        ...
        <p>Nếu đơn đã giao hoặc không còn hủy được, hãy xem điều kiện hoàn hàng để gửi yêu cầu đúng quy trình.</p>

        <div class="policy-action-stack">
          <a class="policy-action-btn primary" href="${pageContext.request.contextPath}/orders">
            <span><i class="fa-solid fa-rotate-left"></i> Gửi yêu cầu từ đơn hàng</span>
            <span>→</span>
          </a>
          <a class="policy-action-btn blue" href="${pageContext.request.contextPath}/policy/cancel">
          ...
          <a class="policy-action-btn light" href="${pageContext.request.contextPath}/orders">
            <span><i class="fa-solid fa-box-open"></i> Theo dõi đơn hàng</span>
            <span>→</span>
          </a>
        </div>
      </aside>
    ...
    <section class="policy-state-grid">
      <article class="policy-state-card ok">
        <span class="state-label">01 | Có thể hỗ trợ</span>
        <h3>Đơn đã giao thành công</h3>
        <p>Yêu cầu hoàn hàng áp dụng khi đơn đã được giao hoặc hoàn thành và còn trong thời hạn hỗ trợ.</p>
      </article>
      <article class="policy-state-card check">
        <span class="state-label">02 | Cần chuẩn bị</span>
        <h3>Lý do và bằng chứng rõ ràng</h3>
        <p>Ảnh, video, tình trạng sản phẩm và mô tả lỗi giúp shop kiểm tra nhanh hơn.</p>
      </article>
      <article class="policy-state-card no">
        <span class="state-label">03 | Có thể từ chối</span>
        <h3>Quá hạn hoặc thiếu căn cứ</h3>
        <p>Yêu cầu có thể bị từ chối nếu sản phẩm đã sử dụng nhiều, quá hạn hoặc không đủ căn cứ kiểm tra.</p>
      </article>
    </section>
    ...
    <section class="policy-main-layout">
      <div class="policy-content-list">
        <article class="policy-section">
          ...
          <p class="lead">Yêu cầu hoàn hàng được tiếp nhận khi đáp ứng đủ các điều kiện dưới đây.</p>
          <ul>
          ...
          <div class="policy-note green">Bạn nên chụp hình hoặc quay video ngay khi mở hàng để việc đối chiếu diễn ra nhanh và thuận tiện hơn.</div>
        </article>
        <article class="policy-section">
          <div class="section-heading">
          ...
          <p class="lead">Shop ưu tiên xử lý các trường hợp ảnh hưởng trực tiếp đến trải nghiệm sử dụng.</p>
          <ul>
        ...
        <article class="policy-section">
          ...
          <p class="lead">Để đảm bảo công bằng, một số yêu cầu có thể không được chấp nhận.</p>
          <ul>
          ...
          <div class="policy-note yellow">Nếu chưa chắc sản phẩm có đủ điều kiện hay không, hãy liên hệ shop trước khi gửi yêu cầu.</div>
        </article>
        <article class="policy-section">
          <div class="section-heading">
            <span class="section-no">4</span>
            <h2>Quy trình hoàn hàng</h2>
          </div>
          <p class="lead">Khách hàng thực hiện hoàn hàng theo các bước sau.</p>
        ...
        <div class="policy-bottom-cta">
          <div>
            ...
            <span> Vào chi tiết đơn hàng đã giao thành công để gửi yêu cầu hoàn hàng.</span>
          </div>
      ...
      <aside class="policy-sidebar">
        <section class="side-card">
          ...
          <div class="summary-list">
            ...
            <div class="summary-item">
              ...
              <span>Lý do rõ ràng, ảnh hoặc video nếu có.</span>
            </div>
            <div class="summary-item">
        ...
        <section class="side-card">
          ...
          <div class="policy-menu">
            ...
            <a class="active" href="${pageContext.request.contextPath}/policy/return">
