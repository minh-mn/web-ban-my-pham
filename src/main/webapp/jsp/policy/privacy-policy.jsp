    ...
    <div class="policy-wrap">
        ...
        <section class="policy-hero">
            <div>
                ...
                <p>Chính sách bảo mật giúp khách hàng hiểu rõ website thu thập thông tin nào, sử dụng vào mục đích gì và cách MyCosmetic bảo vệ dữ liệu cá nhân trong quá trình mua sắm.</p>

                <div class="policy-tags">
                    <span>Bảo vệ dữ liệu cá nhân</span>
                    <span>Chỉ dùng cho mục đích cần thiết</span>
            ...
            <aside class="policy-action-box">
                ...
                <p>Đọc chính sách để biết thông tin nào được lưu và cách shop bảo vệ dữ liệu của bạn.</p>

                <div class="policy-action-stack">
                    <a class="policy-action-btn primary" href="${pageContext.request.contextPath}/account">
                        <span><i class="fa-solid fa-user-shield"></i> Xem tài khoản</span>
                        <span>→</span>
                    </a>
                    <a class="policy-action-btn blue" href="${pageContext.request.contextPath}/policy/payment">
                        <span><i class="fa-solid fa-credit-card"></i> Chính sách thanh toán</span>
                        <span>→</span>
                    </a>
                    <a class="policy-action-btn light" href="${pageContext.request.contextPath}/home">
                        <span><i class="fa-solid fa-house"></i> Về trang chủ</span>
                        <span>→</span>
                    </a>
                </div>
            </aside>
        ...
        <section class="policy-state-grid">
            <article class="policy-state-card ok">
                <span class="state-label">01 | Thu thập cần thiết</span>
                <h3>Thông tin phục vụ đơn hàng</h3>
                <p>Họ tên, số điện thoại, email, địa chỉ và lịch sử mua hàng được dùng để xử lý đơn.</p>
            </article>
            <article class="policy-state-card check">
                <span class="state-label">02 | Sử dụng đúng mục đích</span>
                <h3>Giao hàng và hỗ trợ</h3>
                <p>Thông tin được dùng để xác nhận đơn, giao hàng, bảo hành, đổi trả và chăm sóc khách hàng.</p>
            </article>
            <article class="policy-state-card no">
                <span class="state-label">03 | Bảo vệ dữ liệu</span>
                <h3>Không bán thông tin khách hàng</h3>
        ...
        <section class="policy-main-layout">
            <div class="policy-content-list">
                <article class="policy-section">
                    ...
                    <p class="lead">Shop chỉ thu thập các thông tin cần thiết để phục vụ mua hàng và chăm sóc khách hàng.</p>
                    <ul>
                ...
                <article class="policy-section">
                    ...
                    <p class="lead">Thông tin được sử dụng đúng phạm vi nhằm xử lý giao dịch và hỗ trợ khách hàng.</p>
                    <ul>
                ...
                <article class="policy-section">
                    ...
                    <p class="lead">MyCosmetic không bán dữ liệu khách hàng cho bên thứ ba.</p>
                    <ul>
                    ...
                    <div class="policy-note green">Bạn nên bảo mật tài khoản, không chia sẻ mật khẩu hoặc mã OTP cho người khác.</div>
                </article>

                <div class="policy-bottom-cta">
                    <div>
                        <strong>Cần thao tác ngay?</strong>
                        <span> Vào tài khoản để kiểm tra và cập nhật thông tin cá nhân khi cần.</span>
                    </div>
                    <a href="${pageContext.request.contextPath}/account">Đi tới trang phù hợp</a>
                </div>
            </div>
            ...
            <aside class="policy-sidebar">
                ...
                <section class="side-card">
                    ...
                    <div class="policy-menu">
                        ...
                        <a class="active" href="${pageContext.request.contextPath}/policy/privacy">
