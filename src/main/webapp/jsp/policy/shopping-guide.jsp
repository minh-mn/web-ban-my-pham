    ...
    <div class="policy-wrap">
        ...
        <section class="policy-hero">
            ...
            <aside class="policy-action-box">
                ...
                <p>Làm theo hướng dẫn để đặt hàng nhanh và tránh sai sót thông tin nhận hàng.</p>

                <div class="policy-action-stack">
                    <a class="policy-action-btn primary" href="${pageContext.request.contextPath}/products">
                        <span><i class="fa-solid fa-cart-shopping"></i> Mua sắm ngay</span>
                        <span>→</span>
                    </a>
        ...
        <section class="policy-state-grid">
            <article class="policy-state-card ok">
                <span class="state-label">01 | Chọn sản phẩm</span>
                <h3>Tìm đúng món cần mua</h3>
                <p>Dùng tìm kiếm, danh mục hoặc thương hiệu để chọn sản phẩm phù hợp.</p>
            </article>
            <article class="policy-state-card check">
                <span class="state-label">02 | Kiểm tra giỏ</span>
                <h3>Số lượng, voucher, địa chỉ</h3>
                <p>Rà soát toàn bộ thông tin trước khi xác nhận thanh toán.</p>
            </article>
            <article class="policy-state-card no">
                <span class="state-label">03 | Theo dõi</span>
                <h3>Xem trạng thái đơn hàng</h3>
                <p>Vào mục đơn hàng để kiểm tra xác nhận, lấy hàng, đang giao hoặc hoàn thành.</p>
            </article>
        </section>
        ...
        <section class="policy-main-layout">
            <div class="policy-content-list">
                <article class="policy-section">
                    ...
                    <p class="lead">Bạn có thể hoàn tất đơn hàng theo quy trình sau.</p>
                ...
                <article class="policy-section">
                    ...
                    <p class="lead">Sau khi đặt hàng, khách có thể theo dõi tiến trình xử lý trong tài khoản.</p>
                    <ul>
                ...
                <article class="policy-section">
                    ...
                    <p class="lead">Một số điểm nên kiểm tra trước khi xác nhận đơn.</p>
                    <ul>
                ...
                <div class="policy-bottom-cta">
                    <div>
                        ...
                        <span> Đi tới trang sản phẩm để bắt đầu chọn sản phẩm và đặt hàng.</span>
                    </div>
                    <a href="${pageContext.request.contextPath}/products">Đi tới trang phù hợp</a>
                </div>
            </div>
            ...
            <aside class="policy-sidebar">
                ...
                <section class="side-card">
                    ...
                    <div class="policy-menu">
                        ...
                        <a class="active" href="${pageContext.request.contextPath}/policy/shopping-guide">
