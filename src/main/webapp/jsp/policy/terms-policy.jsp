    ...
    <div class="policy-wrap">
        ...
        <section class="policy-hero">
            <div>
                ...
                <div class="policy-tags">
                    <span>Quy định sử dụng website</span>
                    <span>Quyền và trách nhiệm</span>
                    <span>Áp dụng cho mọi khách hàng</span>
                </div>
            </div>

            <aside class="policy-action-box">
                <h2>Thao tác liên quan</h2>
                <p>Đọc điều khoản để hiểu phạm vi sử dụng website và trách nhiệm của hai bên khi mua hàng.</p>

                <div class="policy-action-stack">
                    <a class="policy-action-btn primary" href="${pageContext.request.contextPath}/home">
                    ...
                    <a class="policy-action-btn light" href="${pageContext.request.contextPath}/policy/privacy">
        ...
        <section class="policy-state-grid">
            <article class="policy-state-card ok">
                <span class="state-label">01 | Áp dụng</span>
                <h3>Khi truy cập và đặt hàng</h3>
                <p>Điều khoản áp dụng khi khách dùng website, đăng ký tài khoản hoặc mua hàng.</p>
            </article>
            <article class="policy-state-card check">
                <span class="state-label">02 | Minh bạch</span>
                <h3>Thông tin chính xác</h3>
                <p>Khách hàng cần cung cấp thông tin đúng để shop xử lý đơn hàng hiệu quả.</p>
            </article>
            <article class="policy-state-card no">
                <span class="state-label">03 | Bảo vệ hệ thống</span>
                <h3>Không gian lận hoặc phá hoại</h3>
                <p>Shop có quyền xử lý các trường hợp gian lận, spam hoặc gây ảnh hưởng hệ thống.</p>
            </article>
        </section>
        ...
        <section class="policy-main-layout">
            <div class="policy-content-list">
                <article class="policy-section">
                    ...
                    <p class="lead">Điều khoản áp dụng cho mọi khách hàng truy cập và sử dụng website.</p>
                    <ul>
                ...
                <article class="policy-section">
                    <div class="section-heading">
                        ...
                        <h2>Quyền và trách nhiệm của MyCosmetic</h2>
                    </div>
                    <p class="lead">Shop có trách nhiệm vận hành website và hỗ trợ khách hàng trong phạm vi hợp lý.</p>
                    <ul>
                ...
                <article class="policy-section">
                    ...
                    <p class="lead">Một số trường hợp ngoài phạm vi kiểm soát trực tiếp của shop.</p>
                    <ul>
                ...
                <div class="policy-bottom-cta">
                    <div>
                        ...
                        <span> Quay lại trang chủ để tiếp tục mua sắm sau khi đã đọc điều khoản.</span>
                    </div>
                    <a href="${pageContext.request.contextPath}/home">Đi tới trang phù hợp</a>
                </div>
            </div>
            ...
            <aside class="policy-sidebar">
                ...
                <section class="side-card">
                    ...
                    <div class="policy-menu">
                        ...
                        <a class="active" href="${pageContext.request.contextPath}/policy/terms">
