    ...
    <div class="policy-wrap">
        ...
        <section class="policy-hero">
            <div>
                ...
                <div class="policy-tags">
                    <span>Chọn VNPay</span>
                    <span>Quét mã / chọn ngân hàng</span>
                    <span>Kiểm tra kết quả giao dịch</span>
                </div>
            </div>

            <aside class="policy-action-box">
                <h2>Thao tác liên quan</h2>
                <p>Dùng hướng dẫn này khi bạn muốn thanh toán online an toàn qua VNPay.</p>
        ...
        <section class="policy-state-grid">
            <article class="policy-state-card ok">
                <span class="state-label">01 | Chọn VNPay</span>
                <h3>Tại trang thanh toán</h3>
                <p>Chọn phương thức VNPay và kiểm tra lại tổng tiền trước khi tiếp tục.</p>
            </article>
            <article class="policy-state-card check">
                <span class="state-label">02 | Giao dịch</span>
                <h3>Quét QR hoặc chọn ngân hàng</h3>
                <p>Thực hiện theo hướng dẫn trên cổng VNPay hoặc ứng dụng ngân hàng.</p>
            </article>
            <article class="policy-state-card no">
                <span class="state-label">03 | Kết quả</span>
                <h3>Quay về MyCosmetic</h3>
                <p>Sau khi hoàn tất, hệ thống sẽ quay về website và cập nhật trạng thái đơn.</p>
            </article>
        </section>
            ...
            <div class="policy-content-list">
                <article class="policy-section">
                    <div class="section-heading">
                        ...
                        <h2>Quy trình thanh toán VNPay</h2>
                    </div>
                    <p class="lead">Thực hiện theo từng bước để tránh lỗi giao dịch.</p>
                ...
                <article class="policy-section">
                    ...
                    <p class="lead">Các lưu ý giúp hạn chế lỗi khi thanh toán online.</p>
                    <ul>
                    ...
                    <div class="policy-note yellow">Nếu đã bị trừ tiền nhưng đơn chưa cập nhật, hãy lưu mã giao dịch và liên hệ shop để được kiểm tra.</div>
                </article>
                <article class="policy-section">
                    <div class="section-heading">
                        <span class="section-no">3</span>
                        <h2>Khi giao dịch thất bại</h2>
                    </div>
                    <p class="lead">Nếu VNPay báo thất bại hoặc hết thời gian thanh toán, bạn có thể xử lý như sau.</p>
                    <ul>
                ...
                <div class="policy-bottom-cta">
                    <div>
                        ...
                        <span> Vào đơn hàng để kiểm tra trạng thái hoặc thanh toán lại nếu giao dịch chưa thành công.</span>
                    </div>
            ...
            <aside class="policy-sidebar">
                ...
                <section class="side-card">
                    ...
                    <div class="policy-menu">
                        ...
                        <a class="active" href="${pageContext.request.contextPath}/policy/vnpay-guide">
