...
<section class="notification-page">
  <div class="notification-page__container">
    ...
    <div class="notification-list-card">
      <div class="notification-list-card__head notification-list-card__head--with-action">
        <div class="notification-list-card__title-block">
        ...
        <div class="notification-read-action">
          <span class="notification-read-action__count">
            <strong><c:out value="${empty unreadCountValue ? 0 : unreadCountValue}" /></strong>
            chưa đọc
          </span>

          <form action="${pageContext.request.contextPath}/notifications"
                method="post"
                class="notification-read-action__form">
            <input type="hidden" name="action" value="markAllRead">
            <input type="hidden" name="csrf_token" value="${sessionScope.CSRF_TOKEN}">
            <button type="submit"
                    class="notification-read-action__btn"
                    <c:if test="${empty unreadCountValue or unreadCountValue le 0}">disabled</c:if>>
